...
String getDateWithWeekday(DateTime dateTime, {int? subDay}) {
  String date = '';
  String day = formatDate(dateTime, ['dd']).toString();
  String month = formatDate(dateTime, ['M']).toString();
  String weekDay = formatDate(dateTime, ['DD']).toString();
  if (subDay != null) {
    weekDay = weekDay.substring(0, subDay);
  }
  //M
  date = "$day $month\n$weekDay";
